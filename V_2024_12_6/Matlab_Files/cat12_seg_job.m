...
function cat12_seg_job(inputFiles,nproc,mask)
    ...
    matlabbatch{1}.spm.tools.cat.estwrite.output.GM.native = 1; % GM native = 1;
    ...
    matlabbatch{1}.spm.tools.cat.estwrite.output.labelnative = 1; % PVE Native
    matlabbatch{1}.spm.tools.cat.estwrite.output.bias.warped = 1;
    matlabbatch{1}.spm.tools.cat.estwrite.output.las.native = 0;
    matlabbatch{1}.spm.tools.cat.estwrite.output.las.warped = 0;
    matlabbatch{1}.spm.tools.cat.estwrite.output.las.dartel = 0;
    matlabbatch{1}.spm.tools.cat.estwrite.output.jacobianwarped = 0;
    matlabbatch{1}.spm.tools.cat.estwrite.output.warps = [1 0]; % Deformation Feilds
