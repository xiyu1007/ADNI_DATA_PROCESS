...
% ROI CSV Copy to  D:\Matlab\R2024b\toolbox\spm12\toolbox\cat12\templates_MNI152NLin2009cAsym
mask = {'template/ROITemplate/AAL3v1_1mm.nii'}; % ROI模板

nproc = 5;  % 电脑核心数，每次处理的文件数量
prefix = 'r'; %筛选需要分割的nii，r表示只会处理r开头的数据
