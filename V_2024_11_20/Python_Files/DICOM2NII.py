...
write_behavior = '0'  # 处理名称冲突的写入行为（0=跳过重复项，1=覆盖，2=添加后缀）
zip2gz = 'n'


def Dcm2Nii(DICOM_Root, Nii_Root, Modality, NiiInAll=True, del_er=False, verbose_mode=False, only_disp_err=True):
...
if __name__ == '__main__':
    ...
    Dcm2Nii(DICOM_Root, Nii_Root, Modality, NiiInAll=True, del_er=True, only_disp_err=True, verbose_mode=True)
    Single_Dicom2Nii()
